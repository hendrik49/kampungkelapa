@include('layouts.header')
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="{{ route('pjb_setahun.update',$Penyerapan_anggaran_setahun_pjb->id) }}" method="POST">
                ...
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  <div class="form-group @if($errors->has('id')) has-error @endif">
                    ...
                    <input type="number" id="tahun-field" name="tahun" class="form-control"  value="{{ $Penyerapan_anggaran_setahun_pjb->tahun }}" />
                       @if($errors->has("tahun"))
                    ...
                    <input type="number" id="jumlah_paket-field" name="jumlah_paket" class="form-control" value="{{ $Penyerapan_anggaran_setahun_pjb->target_paket_pjb }}"/>
                    ...
                    <input type="text" id="nilai_paket-field" name="nilai_paket" class="form-control money" value="{{ $Penyerapan_anggaran_setahun_pjb->nilai_paket_pjb }}" />
