                    ...
                    <table class="table table-condensed table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-right">PRA-DIPA</th>
                            </tr>
                        </thead>
                            ...
                            @foreach($penyerapan_anggaran_pradipas as $penyerapan_anggaran_pradipa)
                                ...
                                @else
                                    ...
                                    <td class="text-right">
                                        ...
                                        @if($penyerapan_anggaran_pradipa->user_id == Auth::user()->id && $penyerapan_anggaran_pradipa->status != 'FINAL')
                                    ...
                                    <td class="text-right">
                                        @if($penyerapan_anggaran_pradipa->status != 'REJECT')
                                        <a class="btn btn-xs btn-success" href="{{ url('penyerapan_anggaran_pradipas/approve', $penyerapan_anggaran_pradipa->id) }}"><i class="glyphicon glyphicon-ok"></i> Terima</a>
                                        <a class="btn btn-xs btn-danger" href="{{ url('penyerapan_anggaran_pradipas/reject', $penyerapan_anggaran_pradipa->id) }}"><i class="glyphicon glyphicon-remove"></i> Tolak</a>
                                        @else
                                        <button type="button" class="btn btn-xs btn-default" disabled><i class="glyphicon glyphicon-ok"></i> Terima</button>
                                        <button type="button" class="btn btn-xs btn-default" disabled><i class="glyphicon glyphicon-remove"></i> Tolak</button>
                                        @endif
                                    </td>
                                @endif     
                                </tr>
