...
<style type="text/css">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Menampilkan No Pra-DIPA: {{$penyerapan_anggaran_pradipa->nama_dipa}}
       </h1>
    </section>
    <section class="content inlineform">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="page-header">
                    <form action="{{ route('penyerapan_anggaran_pradipas.destroy', $penyerapan_anggaran_pradipa->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
                ...
                <form id="form_penyerapan_anggaran_perjenis" data-state="display" class="well well-sm" action="{{ route('penyerapan_anggaran_perjenis.update', $penyerapan_anggaran_perjenis_belanja->id_anggaran) }}" method="POST">                    
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-5" style="display: none">
                                <input type="text" id="belanja_modal-field" name="belanja_modal" class="form-control money" value="{{ is_null(old("belanja_modal")) ? $penyerapan_anggaran_perjenis_belanja->belanja_modal : old("belanja_modal") }}" @if($penyerapan_anggaran_pradipa->jenis == 'd') title="DIPA daerah tidak bisa mengisi belanja modal" readonly @endif/>
            ...
            <div class="col-md-6">
                <div class="page-header">
                    <form action="{{ route('penyerapan_anggaran_pradipas.destroy', $penyerapan_anggaran_pradipa->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
                        ...
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="btn-group pull-right" role="group" aria-label="...">
                            @if($penyerapan_anggaran_pradipa->jenis == 'p')
                                @if($penyerapan_anggaran_pradipa->user_id == Auth::user()->id && $penyerapan_anggaran_pradipa->status == 'DRAFT')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="page-header">
                    <form action="{{ route('penyerapan_anggaran_pradipas.destroy', $penyerapan_anggaran_pradipa->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
                        <small>Rencana Serap Belanja Lainnya </small>
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="btn-group pull-right" role="group" aria-label="...">
                            @if($penyerapan_anggaran_pradipa->user_id == Auth::user()->id && $penyerapan_anggaran_pradipa->status == 'DRAFT')
                ...
                <a class="btn btn-link" href="{{ route('penyerapan_anggaran_pradipas.index') }}"><i class="glyphicon glyphicon-backward"></i>  Kembali</a>
            </div>    
              <div class="col-md-6">
                <div class="page-header">
                    <form action="{{ route('penyerapan_anggaran_pradipas.destroy', $penyerapan_anggaran_pradipa->id) }}" method="POST" style="display: inline;" onsubmit="if(confirm('Delete? Are you sure?')) { return true } else {return false };">
