@include('layouts.header')
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Ubah No DIPA {{$penyerapan_anggaran_target_pjb->nama_dipa}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('penyerapan_anggaran_target_pjbs.update', $penyerapan_anggaran_target_pjb->id) }}" method="POST">
                ...
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <input type="number" id="tahun_anggaran-field" name="tahun_anggaran" class="form-control" value="{{ is_null(old("tahun_anggaran")) ? $penyerapan_anggaran_target_pjb->tahun_anggaran : old("tahun_anggaran") }}"/>
                    ...
                    <div class="form-group @if($errors->has('jenis')) has-error @endif">
                       <label for="triwulan-field">Jenis</label>
                        <select class="form-control" id="jenis-field" name="jenis">                    
                            ...
                            <option value="p" @if($penyerapan_anggaran_target_pjb->jenis == 'p') selected @endif>Pusat</option>
                            <option value="d" @if($penyerapan_anggaran_target_pjb->jenis == 'd') selected @endif>Daerah</option>
                        </select>                       
                       @if($errors->has("pusat"))
                    ...
                    <div class="form-group @if($errors->has('satuan_kerja')) has-error @endif">
                       ...
                       <input type="text" id="satuan_kerja-field" name="satuan_kerja" class="form-control" value="{{$penyerapan_anggaran_target_pjb->satuan_kerja}}" readonly>
                        <!--
                    ...
                    <input type="text" id="nama_dipa-field" name="nama_dipa" class="form-control" value="{{ is_null(old("nama_dipa")) ? $penyerapan_anggaran_target_pjb->nama_dipa : old("nama_dipa") }}"/>
                    ...
                    <div class="form-group @if($errors->has('tanggal_dipa')) has-error @endif">
                       ...
                       <input type="text" id="dpYears" name="tanggal_dipa" class="form-control date dpYears" value="{{ Carbon\Carbon::parse($penyerapan_anggaran_target_pjb->tanggal_dipa)->format('d-m-Y') }}" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    ...
                    <input type="text" id="total_anggaran-field" name="total_anggaran" class="form-control money" value="{{ is_null(old("total_anggaran")) ? number_format($penyerapan_anggaran_target_pjb->total_anggaran) : old("total_anggaran") }}"/>
                    ...
                    <div class="form-group @if($errors->has('status')) has-error @endif">
                       ...
                       <select id="status-field" name="status" class="form-control">
                            <option value="DRAFT" @if($penyerapan_anggaran_target_pjb->status == 'DRAFT') selected @endif>DRAFT</option>
                            <option value="FINAL" @if($penyerapan_anggaran_target_pjb->status == 'FINAL') selected @endif>FINAL</option>
                       </select>
