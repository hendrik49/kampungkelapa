...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Permasalahan Realisasi No DIPA: {{$realisasi_anggaran_target_pjb->nama_dipa}} Triwulan @if($realisasi_anggaran_target_pjb->triwulan==1) I @elseif($realisasi_anggaran_target_pjb->triwulan==2) II @elseif($realisasi_anggaran_target_pjb->triwulan==3) III @else IV @endif                                
        </h1>
    </section>
    <!-- Main content -->
    <section class="content">
        ...
        <div id="details">
            ...
            <form action="{{ url('realisasi_anggaran_target_pjbs/permasalahan', $realisasi_anggaran_target_pjb->id) }}" method="post" id="permasalahan_submit_form">
            ...
            <a class="btn btn-link pull-right" href="{{ url('realisasi_anggaran_target_pjbs', $realisasi_anggaran_target_pjb->id) }}"><i class="glyphicon glyphicon-backward"></i>  Kembali</a>
