@include('layouts.header')
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('kop_spp.update', $Kop_spp->id) }}') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('id')) has-error @endif">
                    ...
                    <input type="text" id="kategori_uraian-field" name="kategori_uraian" class="form-control"  value="{{ is_null(old("kategori_uraian")) ? $Kop_spp->kategori_uraian : old("kategori_uraian") }}"/>
                    ...
                    <input type="text" id="no_kop-field" name="no_kop" class="form-control" value="{{ is_null(old("no_kop")) ? $Kop_spp->no_kop : old("no_kop") }}"/>
                    ...
                    <input type="text" id="uraian_kop-field" name="uraian_kop" class="form-control"  value="{{ is_null(old("uraian_kop")) ? $Kop_spp->uraian_kop : old("uraian_kop") }}"/>
                    ...
                    <div class="form-group @if($errors->has('tgl_kop')) has-error @endif">
                       ...
                       <input type="text" id="tgl_kop-field" name="tgl_kop" class="form-control date dpYears"  value="{{ is_null(old("tgl_kop")) ? $Kop_spp->tgl_kop : old("tgl_kop") }}" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    ...
                    <input type="text" id="nilai_kop-field" name="nilai_kop"  class="form-control money"   value="{{ is_null(old("nilai_kop")) ? $Kop_spp->nilai_kop : old("nilai_kop") }}"/>
                    ...
                    <input type="text" id="no_kontrak-field" name="no_kontrak" class="form-control" value="{{ $Kop_spp->no_kontrak }}"/>
                    ...
                    <div class="form-group @if($errors->has('tgl_kontrak')) has-error @endif">
                       ...
                       <input type="text" id="tgl_kontrak-field" name="tgl_kontrak" class="form-control date dpYears" value="{{ $Kop_spp->tgl_kontrak }}" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    ...
                    <input type="text" id="nilai_kontrak-field" name="nilai_kontrak"  class="form-control money"  value="{{$Kop_spp->nilai_kontrak }}"/>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="no_bap-field" name="no_bap" class="form-control" value="{{ $Kop_spp->no_bap }}"/>
                    ...
                    <div class="form-group @if($errors->has('tgl_bap')) has-error @endif">
                       ...
                       <input type="text" id="tgl_bap-field" name="tgl_bap" class="form-control date dpYears" value="{{ $Kop_spp->tgl_bap }}" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    ...
                    <input type="text" id="no_bast-field" name="no_bast" class="form-control" value="{{ $Kop_spp->no_bast }}"/>
                    ...
                    <div class="form-group @if($errors->has('tgl_bast')) has-error @endif">
                       ...
                       <input type="text" id="tgl_bast-field" name="tgl_bast" class="form-control date dpYears" value="{{ $Kop_spp->tgl_bast }}" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    ...
                    <input type="text" id="no_spp-field" name="no_spp" class="form-control"  value="{{ is_null(old("no_spp")) ? $Kop_spp->no_spp : old("no_spp") }}"/>
                    ...
                    <input type="text" id="uraian_spp-field" name="uraian_spp" class="form-control"  value="{{ is_null(old("uraian_spp")) ? $Kop_spp->uraian_spp : old("uraian_spp") }}"/>
                    ...
                    <div class="form-group @if($errors->has('tgl_spp')) has-error @endif">
                       ...
                       <input type="text" id="tgl_spp-field" name="tgl_spp" class="form-control date dpYears"  value="{{ is_null(old("tgl_spp")) ? $Kop_spp->tgl_spp : old("tgl_spp") }}" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                    ...
                    <input type="text" id="nilai_spp-field" name="nilai_spp"  class="form-control money"   value="{{ is_null(old("nilai_spp")) ? $Kop_spp->nilai_spp : old("nilai_spp") }}"/>
