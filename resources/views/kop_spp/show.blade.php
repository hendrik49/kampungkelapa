        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <form id="form_penyerapan_anggaran_perjenis" data-state="display" class="well well-sm" action="{{ route('penyerapan_anggaran_perjenis.update', $penyerapan_anggaran_perjenis_belanja->id_anggaran) }}" method="POST">                    
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-xs-7" for="triwulan">Belanja Lainnya</label>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <form id="form_penyerapan_anggaran_triwulan_barang" data-state="display" class="well well-sm" action="{{ url('penyerapan_rencana_triwulan_barang', $penyerapan_anggaran_perjenis_belanja->id_anggaran) }}" method="POST">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-xs-7" for="tahun_anggaran">TRIWULAN 1</label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-xs-7" for="triwulan">TRIWULAN 2</label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-xs-7" for="triwulan">TRIWULAN 3</label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label class="col-xs-7" for="triwulan">TRIWULAN 4</label>
